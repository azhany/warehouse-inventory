...
<?php
 if(isset($_POST['add_product'])){
   $req_fields = array('product-title','product-barcode','product-categorie','saleing-price' );
   ...
   if(empty($errors)){
     ...
     $query .=" name,barcode,sale_price,categorie_id,media_id,date";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_barcode}', '{$p_sale}', '{$p_cat}', '{$media_id}', '{$date}'";
     $query .=")";
